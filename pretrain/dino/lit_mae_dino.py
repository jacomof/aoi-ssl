...
class LitMAEDino(LitMAE):
    ...
    def training_step(self, batch: Any, batch_idx: int):
        ...
        with torch.no_grad():
            ...
            self.log("train/dim_collapse_entropy_teacher", entropy_teacher, sync_dist=True, batch_size=batch_size, on_epoch=True)
    ...
    def validation_step(self, batch: Any, batch_idx: int):
        ...
        with torch.no_grad():
            entropy_teacher = compute_entropy(cls_emb_teacher)
            self.log("val/dim_collapse_entropy_teacher", entropy_teacher, sync_dist=True, batch_size=batch_size)
