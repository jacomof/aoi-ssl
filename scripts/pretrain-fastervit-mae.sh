...
# You need to pass your conda location inorder for slurm
...
python -m pretrain.mae.pretrain --config ./configs/pretrain/pretrain_main.yml \
    --model_config ./configs/pretrain/pretrain_fastervit_0_mae_model_config.yml \
    --run_key "pretrain-fastervit-mae" \
    --path "./checkpoints/" \
