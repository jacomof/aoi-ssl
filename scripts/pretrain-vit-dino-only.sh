...
python -m pretrain.dino.pretrain_dino --config ./configs/pretrain/pretrain_main.yml \
    --model_config ./configs/pretrain/pretrain_vit_dino_only_model_config.yml \
    --run_key "pretrain-vit-dino" \
    --path "./checkpoints/" \
